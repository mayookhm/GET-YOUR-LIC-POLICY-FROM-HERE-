class Game {
          ...
          displayRankers() {
            ...
            image(silverImg,displayWidth/4,-100+displayHeight/10,225,240);
            ...
            for (var plr in allPlayers){
              if (allPlayers[plr].place === 1) {
                ...
                text("Thrid : " +allPlayers[plr].name,displayWidth/-4,displayHeight/10+76);
              }else{
                textSize(30);
                text("Memorable Mention : "+allPlayers[plr].name,0,225);
              }
            }
          } 
